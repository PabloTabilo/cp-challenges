...
// https://github.com/williamfiset/Algorithms/blob/master/src/main/java/com/williamfiset/algorithms/graphtheory/networkflow/NetworkFlowSolverBase.java
public abstract class NetworkFlowSolverBase {
	...
	public static class Edge {
		...
		public String toString(int s, int t) {
			...
			String v = (from == s) ? "s" : ((from == t) ? "t": String.valueOf(from));
	...
	// 'visited' and 'visitedToken' are variable used for graph sub-routines to
	// track wheter a node has been visited or not.
	// In particular, node 'i' was recently visited if visited[i] == visitedToken is true
	// This is handy because to mark all nodes as unvisited simply
	// increment the visitedToken
	 ...
	 * 
	 * @param n - The number of nodes in the graph including source and sink
	 ...
	 * 
	 * @param from - The index of the node the directed edge start at.
	...
	/*
	 * Returns the graph after the solver has been executed. This allow you to inspect
	 * the {@link Edge#flow} compared to the {@link Edge#capacity} in each edge.
	 * This is useful if you want to figure out which edges were used during the max flow.
	 *  
	 */
	...
	// NOTE: this methods only applies to min-cost max-flow algorithms
	...
	// of the cut with the source are marked as true and those on the "right side" of
	// the cut with the sink are marked as false.
